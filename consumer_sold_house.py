...
collection = m[setting['mongo']['db_name']][setting['mongo']['collection2']]


class RealtorSoldHouseConsumer:
    ...
    def __init__(self):
        ...
        self.channel.queue_declare(queue='sold_price')
        self.headers = {
    ...
    def start_consuming(self):
        ...
        self.channel.basic_consume(self.callback, queue='sold_price')
