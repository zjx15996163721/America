...
collection = m[setting['mongo']['db_name']][setting['mongo']['collection1']]


class RealtorSaleHouseConsumer:
    ...
    def __init__(self):
        ...
        self.channel.queue_declare(queue='list_price')
        self.headers = {
    ...
    def start_consuming(self):
        ...
        self.channel.basic_consume(self.callback, queue='list_price')
